...
- `prompts/`: ワーカー役割プロンプト (crawl-worker, news-scan, vendor-deep-dive, community-leads, model-fanout, provider-monitor, product-monitor, program-monitor, nim-verify, benchmark-scout, classifier-agent, editor-agent)
...
1. catalog (決定的コード) + known_refresh / 研究セッション (news-scan, vendor-deep-dive, community-leads, model-fanout)
